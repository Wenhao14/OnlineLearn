...
function navUrl(sel){
	switch(sel){
		case 2:{
			window.location.href="/page/front/news_notice.html";
			break;
		}
		case 3:{
		...
		case 4:{
			window.location.href="/page/front/re_course.html"
			break;
		}
		case 5:{
            window.location.href="/page/front/hot_course.html"
			break;
		}
		case 6:{
			window.location.href="/page/front/local_resource_base.html"
			break;
		}
		default:{
			window.location.href="/index.html"
